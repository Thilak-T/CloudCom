...
@NamedQueries({
    ...
    @NamedQuery(name = "SurveyResponse.findByUserId", query = "SELECT s FROM SurveyResponse s WHERE s.person.email = :userId"),
...
public class SurveyResponse implements Serializable {
    ...
    @XmlElement(required=true) 
    private SurveyOptions selectedOption;
    ...
    public String toString() {
        return "com.ejca.entities.SurveyResponse[ id=" + id + " ]";
    }
